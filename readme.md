...
This will create an executable jar file **backend-microbundle.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/backend-microbundle.jar
...
java -jar target/microservice-jee8-microbundle.jar target/microservice-jee8.war
